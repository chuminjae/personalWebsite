import { findPagePContent } from "./ProjectexplanationpageContents.js";
...
function renderProjectexplanationPage() {
  renderHeader2("project");
  let explanationHTML = ``;
  const url = new URL(window.location.href);
  const target = url.searchParams.get("ProjectId");
  let explanationContent = findPagePContent(target);
